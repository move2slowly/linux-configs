...
xinput query-state "Metadot - Das Keyboard Das Keyboard" 2>&1 > /dev/null && KEYBOARD_ID="Metadot - Das Keyboard Das Keyboard" 
xinput query-state "ACER USB-HID Gaming Keyboard (D) Keyboard" 2>&1 > /dev/null && KEYBOARD_ID="ACER USB-HID Gaming Keyboard (D) Keyboard" 
echo $KEYBOARD_ID
